...
import { demoAdminUsers } from '@/lib/services/demo-admin';
...
export default function AdminUsersPage() {
  return (
    <AdminSectionShell
      ...
      title="จัดการผู้ใช้"
      description="ตรวจสอบบทบาทและสถานะของโปรไฟล์ในระบบตัวอย่าง พร้อมทางลัดไปยังหน้าที่เกี่ยวข้องกับการตรวจสอบการใช้งานจริง."
    >
      <Card>
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm text-slate-500">Demo identity registry</p>
